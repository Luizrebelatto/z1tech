  ...
  return (
    <View>
      ...
      <View style={{ justifyContent: 'center', alignItems: 'center' }}>
        <Image
          source={require('../../assets/bards.png')}
        ...
        <Image
          source={require('../../assets/slidertwo.png')}
          style={{ width: 61, height: 12, marginTop: 31 }}
        />
        <TouchableOpacity style={styles.button} activeOpacity={0.8} onPress={() => navigation.navigate('OnboardingThree' as never)}>
