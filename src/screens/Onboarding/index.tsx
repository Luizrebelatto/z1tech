  ...
  return (
    <View>
      ...
      <View style={{ justifyContent: 'center', alignItems: 'center' }}>
        ...
        />
        <Text style={styles.welcomeTitle}>Welcome To Amanah Vault</Text>
        ...
        />
        <TouchableOpacity style={styles.button} activeOpacity={0.8} onPress={() => navigation.navigate('OnboardingTwo' as never)}>
